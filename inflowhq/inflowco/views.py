...
class BaseSitemap(Sitemap):
    def items(self):
        return ["login",
                ...
                "htmldemos:client_active_use_quick_view",
                "htmldemos:client_active_use_specific_project_milestones",
                ...
                "htmldemos:client_active_use_specific_project_milestones_preview",
                "htmldemos:client_active_use_specific_project_milestones_preview_note",
                "htmldemos:client_active_use_specific_project_milestones_schedule",
                "htmldemos:client_active_use_specific_project_milestones_schedule_send",
