...
urlpatterns = [
    ...
    url(r'^work-contract/(?P<contract_slug>[-\w]+)-(?P<contract_id>[0-9]+)/milestones/reject/(?P<milestone_id>[0-9]+)/confirm', views.ClientSpecificProjectPreviewMilestoneRejectConfirm.as_view(), name='client_project_milestones_reject_confirm'),
    url(r'^work-contract/(?P<contract_slug>[-\w]+)-(?P<contract_id>[0-9]+)/milestones/reject/(?P<milestone_id>[0-9]+)', views.ClientSpecificProjectPreviewMilestoneReject.as_view(), name='client_project_milestones_reject'),
    ...
    url(r'^amend-contract/(?P<contract_slug>[-\w]+)-(?P<contract_id>[0-9]+)/overview', views.AmendContractOverview.as_view(), name='amend_contract_overview'),
    url(r'^amend-contract/(?P<contract_slug>[-\w]+)-(?P<contract_id>[0-9]+)/view', views.ViewContractAmendments.as_view(), name='view_contract_amendments'),
