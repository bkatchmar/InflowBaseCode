...
class Recipient(models.Model):
    ContractForRecipient = models.ForeignKey(Contract,unique=True)
    Name = models.CharField(max_length=200)
...
class Milestone(models.Model):
    ...
    MilestoneContract = models.ForeignKey(Contract,unique=False)
...
class Relationship(models.Model):
    ContractUser = models.ForeignKey(User,unique=False)
    ContractForRelationship = models.ForeignKey(Contract,unique=False)
...
class PaymentPlan(models.Model):
    ContractForPaymentPlan = models.ForeignKey(Contract,unique=True)
    PaymentType = models.CharField(max_length=1,choices=CONTRACT_PAYMENT_LEVELS,default='o')
    ContractCurrency = models.ForeignKey(Currency,unique=False)
...
class Payment(models.Model):
    ContractForPayment = models.ForeignKey(Contract,unique=False)
